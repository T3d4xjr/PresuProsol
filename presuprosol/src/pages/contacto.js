  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const emailData = {
        ...
        from: profile?.email || session?.user?.email || "noreply@presuprosol.com",
        subject: `[PresuProsol] ${formData.asunto || "Nueva consulta desde el formulario de contacto"}`,
        text: `
╔════════════════════════════════════════════════════════════════╗
...
👤 Nombre:           ${profile?.usuario || "No especificado"}
📧 Email:            ${profile?.email || session?.user?.email || "No proporcionado"}
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Este mensaje fue enviado desde el formulario de contacto de PresuProsol.
Por favor, responde directamente al email del cliente para una atención personalizada.
        `.trim(),
      };
